...
namespace Petrol_Pump_Point_Of_Sale_System.Persistence.Repositories
{
    public class ProductRepository : Repository<Products> , IProductRepository
    {
        ...
        public bool ProductNameAlreadyExist(string productName)
        {
            return DatabaseContext.Products
                       .Count(p => p.ProductName == productName) == 1;
        }

        public bool ProductNameAlreadyExist(string productName, int id)
        {
            return DatabaseContext.Products
                       .Count(p => p.ProductName == productName &&
                                   p.Id != id) == 1;
        }
    }
